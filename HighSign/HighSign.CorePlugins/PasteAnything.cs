...
{
	public class PasteAnything : IPlugin
	{
		...
		{
			get { return "Paste anything that supports Ctrl+V"; }
		}
		...
		public bool Gestured(Common.Plugins.PointInfo ActionPoint)
		{
            ...
            inputSim.Keyboard.ModifiedKeyStroke(WindowsInputSimulator.Native.VirtualKeyCode.CONTROL, WindowsInputSimulator.Native.VirtualKeyCode.VK_V);
