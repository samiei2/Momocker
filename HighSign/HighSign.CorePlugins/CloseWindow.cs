...
{
	public class CloseWindow : IPlugin
	{
		...
		{
			get { return "Close window using Alt+F4"; }
		}
		...
		public bool Gestured(Common.Plugins.PointInfo ActionPoint)
		{
            ...
            inputSim.Keyboard.ModifiedKeyStroke(WindowsInput.Native.VirtualKeyCode.LMENU, WindowsInput.Native.VirtualKeyCode.F4);
